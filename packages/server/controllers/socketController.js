...
module.exports.addFriend = async (socket, friendName, cb) => {
    ...
    const splittedcurrent = currentFriendList.map(a => a.split('.'))
    const mappedcurrent = splittedcurrent.map(a => a[0])
    // console.log(mappedcurrent)
    if (currentFriendList && mappedcurrent.indexOf(friendName) !== -1) {
